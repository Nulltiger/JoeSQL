...
-- Personal note: utilized "where" clause because it extracts specific words
...
-- Personal note this was tougher. It required a wild card %x% inorder to substitute the missing characters in the string.
...
-- Personal note: apparently you have to use modify with mysql instead of alter column.
...
-- personal note: Having is necessary instrad of where since groupby was utilized.
SELECT last_name, COUNT(*) AS 'Number of Actors' 
...
staff.staff_id = payment.staff_id AND payment_date LIKE '2005-07%'; 
